...
if __name__ == "__main__":
    ...
    # array = array.reshape((15, 1, 2))
    # dummy_y = np.zeros((20, 1, 2)).astype(np.float32)
    #
    # model = M2P3().cuda()
    # inp = [torch.from_numpy(array).cuda(), torch.from_numpy(dummy_y).cuda()]
    #
    # time_taken = 0
    # res = None
    # for i in range(10):
    ...
    # print("Time taken: {:.4f}ms".format(time_taken / 10))
    # print(res.squeeze())
    train()
